...
/**
 * Class Jaro_BibleTeacher_MinorController
 */
class Jaro_BibleTeacher_MinorController extends Mage_Adminhtml_Controller_Action
{
    /**
     *
     */
