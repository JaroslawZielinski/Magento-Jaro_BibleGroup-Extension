...
/**
 * Class Jaro_BibleTeacher_Block_Bible_Verses_Tab_Canons_Grid
 */
class Jaro_BibleTeacher_Block_Bible_Verses_Tab_Canons_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('verses',
            array(
                ...
                'width' => '50px',
                'index' => 'id',
                'renderer' => 'Jaro_BibleTeacher_Block_System_Renderer_CanonsMinors',
                'filter' => false
            )
        );
    ...
    {
        return $this->getUrl('*/adminhtml_canons/edit', array('id' => $row->getId()));
    }

    protected function _prepareMassaction()
    {
        $modelPk = Mage::getModel('jaro_bibleteacher/bible')->getResource()->getIdFieldName();
