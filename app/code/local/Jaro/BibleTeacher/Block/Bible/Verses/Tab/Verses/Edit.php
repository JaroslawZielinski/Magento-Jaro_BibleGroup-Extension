...
/**
 * Class Jaro_BibleTeacher_Block_Bible_Verses_Tab_Verses_Edit
 */
class Jaro_BibleTeacher_Block_Bible_Verses_Tab_Verses_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
