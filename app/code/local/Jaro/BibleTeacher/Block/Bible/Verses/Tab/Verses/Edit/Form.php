...
/**
 * Class Jaro_BibleTeacher_Block_Bible_Verses_Tab_Verses_Edit_Form
 */
class Jaro_BibleTeacher_Block_Bible_Verses_Tab_Verses_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
    /**
     * Inicjuj klasę
     */
    public function __construct()
    {
        ...
        $this->setId('jaro_bibleteacher_bible_verses_tab_verses_form');
        $this->setTitle(Mage::helper('jaro_bibleteacher')->__('All Verse'));
    }

    protected function _getModel()
    {
        return Mage::registry('jaro_bibleteacher_verses');
    }
